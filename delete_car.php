		...
		<table>
			<thead>
				<tr>
					...
					<th class="shows2">Type</th>
					<th class="shows3">ModeL</th>
					<th class="shows4">Date Of Make</th>
					<th class="shows4">Country Of Make</th>
					<th class="shows5">Price</th>
					<th>Delete</th>
				</tr>
			</thead>
					...
					<?php
						...
						for ($i=0; $i <$count ; $i++) { echo"
							...
							<td class='show'>".$array[$i][0]."</td>
						 	...
						 	<td >
						 	<a href='http://localhost/project/delete_carsql.php?id=".$array[$i][3]."'>
