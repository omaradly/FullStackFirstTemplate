		...
		<table>
			<thead>
				<tr>
					...
					<th class="shows3">Job</th>
					<th class="shows4">Department Id</th>
					<th class="shows4">Salary</th>
					<th class="shows5">Phone Number</th>
					<th>UPDATE</th>
				</tr>
			</thead>
				...
				<tbody>
					...
					<?php
						...
						for ($i=0; $i <$count ; $i++) { echo"
							<tr>
							<td class='show2'>".$array[$i][5]."</td>
							<td class='show'>".$array[$i][0]."</td>
						 	<td class='show'>".$array[$i][1]."</td>
						 	<td class='show'>".$array[$i][2]."</td>
						 	<td class='show'>".$array[$i][3]."</td>
						 	<td class='show'>".$array[$i][4]."</td>
						 	<td >
						 	<a href='http://localhost/project/update_employeesql.php?id=".$array[$i][5]."'>
